...
- The server administration window is now using the [react-realm-context](https://github.com/realm/react-realm-context) library. ([#1027](https://github.com/realm/realm-studio/pull/1027))
